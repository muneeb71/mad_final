...
const HomePlace = ({navigation}) => {
  ...
  const handleClick = async(cords, data) => {
    const options = {
      method: 'GET',
    ...
    try {
      ...
      navigation.navigate('Accomodation', {data: (response.data), place: data.description});
    } catch (error) {
      console.log(error);
      ToastAndroid.show(
      ...
      <View style={styles.backimg}>
        ...
        <View style={[styles.inputContainer]}>
          ...
          onPress={(data, details = null) => {
            var cords = details?.geometry?.location
            handleClick(cords, data);
          }}
          query={{
            key: 'AIzaSyCE-urkv2C2AsHamPfmFTSGZ97ig_HzWmY',
            language: 'en',
          }}
           />
        </View>
        <View style={styles.text}>
          ...
          <Text style={styles.white}>
            Island in Bali supporting green campaign
          </Text>

          <Text style={styles.rs}>$89.95 USD - Estimated</Text>
        </View>
        <Text style={styles.wel1}>Trending Green Venues</Text>
        ...
        <View style={styles.Text}>
          ...
          <Text style={styles.text1}>Amazon</Text>
          <Text style={styles.text1}>Spain</Text>
        </View>
      </View>
    </View>
  );
